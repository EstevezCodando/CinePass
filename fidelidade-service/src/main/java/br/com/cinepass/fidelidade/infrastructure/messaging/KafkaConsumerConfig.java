...
public class KafkaConsumerConfig {
    ...
    public ConcurrentKafkaListenerContainerFactory<String, String> kafkaListenerContainerFactory(
        ...
        // Consome apenas o que é responsabilidade deste serviço: mensagens cujo
        // header eventType indique outro tipo são descartadas antes do listener.
        factory.setRecordFilterStrategy(record -> {
            var header = record.headers().lastHeader("eventType");
            return header != null && !"ReservaConfirmada".equals(new String(header.value(), StandardCharsets.UTF_8));
        });
